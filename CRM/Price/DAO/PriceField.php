 ...
 * (GenCodeChecksum:72ba09030c788ff772fa44b7414cf213)
 */
...
class CRM_Price_DAO_PriceField extends CRM_Core_DAO {
  ...
  /**
   * Show how many spaces are remaining
   *
   * @var bool|string
   *   (SQL type: tinyint)
   *   Note that values will be retrieved from the database as a string.
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'show_remaining' => [
          ...
          'description' => ts('Show how many spaces are remaining'),
          'required' => TRUE,
          'where' => 'civicrm_price_field.show_remaining',
          'default' => '0',
          'table_name' => 'civicrm_price_field',
          'entity' => 'PriceField',
          'bao' => 'CRM_Price_BAO_PriceField',
